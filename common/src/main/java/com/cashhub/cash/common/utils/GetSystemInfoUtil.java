...
/** * 获取手机系统内部信息工具类 * Created by yangbin on 3/2/2017. */
public class GetSystemInfoUtil {
  ...
  /** * 系统4.0的时候 * 获取手机IMEI 或者Meid * * @return 手机IMEI */
  ...
  /** * 拿到imei或者meid后判断是有多少位数 * * @param ctx * @return */
  ...
  /** * Flyme 说 5.0 6.0统一使用这个获取IMEI IMEI2 MEID * @param ctx * @return */
